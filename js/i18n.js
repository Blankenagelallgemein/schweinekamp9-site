...
const translations = {
  de: {
    ...
    "bewohner.login.forgot": "Passwort vergessen? Frag deine Mitbewohner oder schreib an kontakt@schweinekamp9.de",
    ...
    "bewohner.faq.repair.a": "Schreib eine kurze Mail an <strong>kontakt@schweinekamp9.de</strong> mit einer Beschreibung und Foto des Problems. Wir kümmern uns in der Regel innerhalb von 48 Stunden.",
  ...
  en: {
    ...
    "bewohner.login.forgot": "Forgot the password? Ask your flatmates or write to kontakt@schweinekamp9.de",
    "bewohner.nav": "Navigation",
    ...
    "bewohner.faq.repair.a": "Send a short email to <strong>kontakt@schweinekamp9.de</strong> with a description and photo of the problem. We usually take care of it within 48 hours.",
