...
const translations = {
  de: {
    ...
    "agb.duration.title": "§ 5 Mietdauer & Kündigung",
    "agb.duration.text": "Die Mindestmietdauer beträgt 6 Monate. Danach kann das Mietverhältnis mit einer Frist von 3 Monaten zum Monatsende gekündigt werden. Die Kündigung bedarf der Schriftform. Das Recht zur außerordentlichen Kündigung aus wichtigem Grund bleibt unberührt.",
    "agb.rules.title": "§ 6 Hausordnung",
    ...
    "agb.furnishing.title": "§ 7 Möblierung & Inventar",
    ...
    "agb.final.title": "§ 9 Schlussbestimmungen",
  ...
  en: {
    ...
    "agb.duration.title": "§ 5 Rental Duration & Termination",
    "agb.duration.text": "The minimum rental period is 6 months. After that, the tenancy can be terminated with 3 months' notice to the end of the month. Termination must be in writing. The right to extraordinary termination for good cause remains unaffected.",
    "agb.rules.title": "§ 6 House Rules",
    ...
    "agb.furnishing.title": "§ 7 Furnishing & Inventory",
    ...
    "agb.liability.title": "§ 8 Liability",
    ...
    "agb.final.title": "§ 9 Final Provisions",
